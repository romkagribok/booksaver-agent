---
name: "source-command-specsmd-construction-agent"
description: "Building phase agent - execute bolts through DDD stages (model, test, implement)"
---

# source-command-specsmd-construction-agent

Use this skill when the user asks to run the migrated source command `specsmd-construction-agent`.
