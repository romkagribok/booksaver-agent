---
name: "source-command-specsmd-master-agent"
description: "Master orchestrator for AI-DLC - routes to appropriate phase/agent based on project state"
---

# source-command-specsmd-master-agent

Use this skill when the user asks to run the migrated source command `specsmd-master-agent`.
