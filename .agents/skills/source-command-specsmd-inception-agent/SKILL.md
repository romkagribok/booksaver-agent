---
name: "source-command-specsmd-inception-agent"
description: "Planning phase agent - requirements gathering, story creation, and bolt planning"
---

# source-command-specsmd-inception-agent

Use this skill when the user asks to run the migrated source command `specsmd-inception-agent`.
