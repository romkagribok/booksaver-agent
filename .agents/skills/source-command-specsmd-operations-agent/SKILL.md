---
name: "source-command-specsmd-operations-agent"
description: "Deployment phase agent - build, deploy, verify, and monitor releases"
---

# source-command-specsmd-operations-agent

Use this skill when the user asks to run the migrated source command `specsmd-operations-agent`.
