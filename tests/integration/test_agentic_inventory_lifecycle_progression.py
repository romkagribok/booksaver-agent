...
def _reservation():
    return ReservationObservation(
        ...
        property_name="Synthetic Hotel", property_ref="synthetic-property",
...
@pytest.mark.parametrize("changes", [
    ...
    {"check_out": date(2026, 9, 15)}, {"property_name": "Different Hotel"},
    {"property_ref": "different"}, {"room_type": "Different Room"},
