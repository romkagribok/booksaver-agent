...
## Release fit-9a783f4 (2026-09-23)

Full-width streamed login on phones (US-202, Bolt 082, ADR-054): fullscreen remote window for
every device, framebuffer aspect negotiated from the viewer area, compact chrome. Bugbot found
that resumed viewers lacked the negotiated aspect; fixed by carrying the framebuffer in the viewer
