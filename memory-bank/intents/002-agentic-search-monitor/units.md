...
| `002-agentic-escalation` | LLM browser-agent step takeover (tiered observations); action guard + hard cost caps; step traces + failure snapshots + CLI | US-020, US-021, US-022 | 001-search-journey-monitor | 2 | Complete |
