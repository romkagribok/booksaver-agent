...
- Before merging a pull request, wait for Cursor Bugbot to review the final head commit. Run
  ...
  follow-up commit. A missing or stale Bugbot review is a blocked gate, not a clean pass.
